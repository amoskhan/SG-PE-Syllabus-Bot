...
import { MediaData } from './geminiService'; // Re-use type if possible, or redefine
...
export const sendMessageToDeepSeek = async (
    ...
    try {
        ...
        const messages = [
            ...
            ...history,
            { role: "user", content: enhancedMessage } // Use enhancedMessage which contains the pose stats
        ];
        ...
        const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                "messages": messages,
                "temperature": 0.5, // Lower temp for grading
                "max_tokens": 3000
            })
        });
