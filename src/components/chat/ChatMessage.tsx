                  ...
                  <div className="flex items-center justify-between mt-2 px-1">
                    ...
                    {onAnalyze && (
                      <button
                        ...
                        className="text-sm font-bold bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-xl shadow-md transition-all flex items-center gap-2 hover:scale-[1.02] active:scale-[0.98]"
